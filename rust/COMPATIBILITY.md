...
| `/capabilities` | exact 79-action legacy set, legacy discovery/passthrough/transport metadata, duplicate guard and formal 404 unknown-action behavior | complete |
