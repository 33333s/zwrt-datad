...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="datad-webshell-") as tmp:
        ...
        try:
            ...
            fragmented.sendall(masked_frame(0, b"y", fin=True))
            fragmented.close()
            ...
            while time.monotonic() < deadline:
                ...
                raise AssertionError("WebShell sessions were not reclaimed before limit test")
            ...
            while time.monotonic() < deadline:
                ...
                raise AssertionError("concurrent WebShell sessions were not reclaimed")
